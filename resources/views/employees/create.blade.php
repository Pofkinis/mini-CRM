                ...
                <form method="POST" action="{{ route('employees.store') }}">
                    ...
                    <div class="flex flex-col space-y-6">
                        <div>
                            ...
                            <x-jet-input id="first_name" value="{{ old('first_name') }}" class="block mt-1 w-full" type="text" name="first_name" required autofocus />
                            @error('first_name')
                        ...
                        <div>
                            ...
                            <x-jet-input id="last_name" value="{{ old('last_name') }}" class="block mt-1 w-full" type="text" name="last_name" required autofocus />
                            @error('last_name')
                            <p class="text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <x-jet-input id="phone" value="{{ old('phone') }}" class="block mt-1 w-full" type="text" name="phone" autofocus />
                            @error('phone')
                            <p class="text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
